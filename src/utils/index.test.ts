...
import { toPlainDate } from "../convert/index.js";
...
describe("Utils Functions", () => {
  describe("pipe", () => {
    it("should execute functions left to right", () => {
      ...
      const result = pipe(Temporal.PlainDate.from("2025-11-30"), addDays, addWeeks);
  ...
  describe("compose", () => {
    ...
    it("should handle type transformations", () => {
      ...
      const result = transform(Temporal.PlainDateTime.from("2025-11-30T00:00:00"));
