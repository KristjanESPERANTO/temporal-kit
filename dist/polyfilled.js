...
var [Ln, Vn] = createSlotClass(qt, Pt(kt, Mt), {
  ...Pn,
  ...Dn
}, {
...
var [kn, qn] = createSlotClass(Ut, Pt(Qt, Mt), {
  ...Pn,
  ...hn
}, {
...
var [xn, Wn] = createSlotClass(G, Pt(ue, Mt), {
  ...Pn,
  ...Tn
}, {
...
var [Hn, Kn] = createSlotClass(Re, qe, On, {
...
function isPlainDate(value) {
  return value instanceof Xn.PlainDate;
}
function isPlainDateTime(value) {
  return value instanceof Xn.PlainDateTime;
}
function isPlainTime(value) {
  return value instanceof Xn.PlainTime;
}
function isZonedDateTime(value) {
  return value instanceof Xn.ZonedDateTime;
}
function isInstant(value) {
  return value instanceof Xn.Instant;
}
function isDateLike(value) {
  return value instanceof Xn.PlainDate || value instanceof Xn.PlainDateTime || value instanceof Xn.ZonedDateTime;
}
...
function now() {
  return Xn.Now.zonedDateTimeISO();
}
function fromISO(isoString) {
  if (isoString.includes("[") || /[+-]\d{2}:\d{2}$/.test(isoString)) {
    return Xn.ZonedDateTime.from(isoString);
  }
  if (isoString.endsWith("Z") || /[+-]\d{2}:\d{2}/.test(isoString)) {
    return Xn.Instant.from(isoString);
  }
  if (isoString.includes("T")) {
    return Xn.PlainDateTime.from(isoString);
  }
  return Xn.PlainDate.from(isoString);
}
function toPlainDate(date) {
  if (date instanceof Xn.PlainDate) {
    return date;
  }
  return date.toPlainDate();
}
function toPlainDateTime(date) {
  if (date instanceof Xn.PlainDateTime) {
    return date;
  }
  return date.toPlainDateTime();
}
function toZonedDateTime(date, timeZone) {
  if (date instanceof Xn.ZonedDateTime) {
